...
<div class="w3-main" style="margin-left:300px">
  ...
  <!-- 第一個圖片格子-->
  <div class="w3-container w3-padding-large w3-khaki" style="margin-bottom:32px; font-size: 20px">
    <div class="w3-container">
          ...
          <table border="1px" style="margin:32px">
            ...
            <tbody>
              <?php
                ...
                $sql="SELECT file_name,upload_time FROM File_Manager WHERE user='$user'";
                if($result= mysqli_query($link, $sql)){
                  while($rs = $result->fetch_assoc()) {
                    $fname= $rs['file_name'];
                    $time= $rs['upload_time'];
                    $path=$upload_folder.'/'.urldecode($fname);
                  ?>
                  <tr>
                    <td width='15%' style="text-align: center;"><input type="checkbox" name="checkbox[]" value="<?php echo $fname;?>" id="<?php echo $fname;?>"></td>
                    <td width='40%'><a style="color: blue;" href='<?php echo $path;?>'><?php echo $fname;?></a></td>
                    <td width='86%'><?php echo $time?></td>
                  </tr>
                <?php
                  }
                }
